...
- `fatorial.txt`: calcula o fatorial de qualquer número inserido.
- `fibonacci.txt`: calcula o n valor da sequência de Fibonacci.
- `somaVetor.txt`: soma todos os elementos de um vetor de tamanho n.